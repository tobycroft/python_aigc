...
class Post:
    ...
    def Int(key: str):
        ...
        try:
            ...
            abort(make_response(fail(400, echo=f"POST-[{key}] is not an integer")))
    ...
    def Float(key: str):
        ...
        try:
            ...
            abort(make_response(fail(400, echo=f"POST-[{key}] is not a float")))
    ...
    def Bool(key: str) -> bool:
        ...
        try:
            ...
            abort(make_response(fail(400, echo=f"POST-[{key}] is not a boolean")))
